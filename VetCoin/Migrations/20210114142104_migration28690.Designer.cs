...
namespace VetCoin.Migrations
{
    ...
    [Migration("20210114142104_migration28690")]
    partial class migration28690
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetCoin.Data.ExtApp.ExteralApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ExteralApplications");
                });

            modelBuilder.Entity("VetCoin.Data.ExtApp.ExteralApplicationPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ExteralApplicationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("IsPayd")
                        .HasColumnType("bit");

                    b.Property<string>("RefJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ExteralApplicationId");

                    b.ToTable("ExteralApplicationPayments");
                });
            ...
            modelBuilder.Entity("VetCoin.Data.VenerEntityes.Vender", b =>
                {
                    ...
                    b.Property<bool>("IsSalesPublicNotification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VetCoin.Data.ExtApp.ExteralApplicationPayment", b =>
                {
                    b.HasOne("VetCoin.Data.ExtApp.ExteralApplication", "ExteralApplication")
                        .WithMany("ExteralApplicationPayments")
                        .HasForeignKey("ExteralApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExteralApplication");
                });
            ...
            modelBuilder.Entity("VetCoin.Data.ExtApp.ExteralApplication", b =>
                {
                    b.Navigation("ExteralApplicationPayments");
                });
